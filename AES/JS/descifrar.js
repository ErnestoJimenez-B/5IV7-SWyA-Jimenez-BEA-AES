...
function abrirArchivo (evento){
    ...
    if(archivo){
        ...
        document.getElementById('mensajes').innerText = "No hay un archivo seleccionado" 
    }
}
    ...
    switch(tipoDeAES){
        case "128":
            if (llave.length <= 16){
                ...
                swal("La llave debe ser de 16 caracteres", "error");
            }
                break
        case "192":
            if(llave.length <= 24){
                ...
                swal("La llave debe ser de 24 caracteres", "error");
            }
            break
        case "256":
            if(llave.length <= 32){
                ...
                swal("La llave debe ser de 32 caracteres", "error");
            }
            break
    }
